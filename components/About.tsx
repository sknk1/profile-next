...
export default function About() {
  return (
    <>
      <div className="container m-auto flex flex-col justify-center gap-10 lg:h-screen">
        <div className="flex flex-row flex-wrap items-center justify-center gap-10 lg:gap-0">
          <div className="relative w-full lg:w-1/3">
            <div className="xl-h-[350px] xl-w-[350px] m-auto h-[250px] w-[250px] rounded-full bg-yellow-custom lg:h-[300px] lg:w-[300px]"></div>
            <Image
